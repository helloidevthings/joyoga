    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-center w-full max-w-3xl mx-auto">
        ...
        <section className="justify-items-center text-center">
          ...
          <p>
            <span className="text-lg font-bold">Joyanna</span> is a yoga instructor based in Knoxville, TN. Joyanna is passionate about helping others find their own joy through movement and mindfulness.
          </p>
        </section>
        <section className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center sm:justify-center w-full">
          ...
          Playlists</a>
          <a
            className="btn btn-secondary w-full sm:w-auto md:w-[158px]"
        ...
        <section>
          ...
          <p>I specialize in teaching yoga. 📍 Currently, you can find me at <a
        ...
        <h4 className="text-1xl font-bold">Every Saturday after March 21st!</h4>
          ...
          <br />
          <Link
            className="btn btn-primary w-full sm:w-auto md:w-[240px]"
            href="/signup"
          >
